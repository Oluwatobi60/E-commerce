...
<div class='row'>
    <div class='col-md-12'>
        <h4 class='text-center text-info mb-5'>Related poducts</h4>
    </div>
    <div class='col-md-6'>
...
function cart_item(){
  ...
  function total_cart_price(){
    ...
    while($row=mysqli_fetch_array($result)){
      ...
      while($row_product_price=mysqli_fetch_array($result_products)){
        $product_price=array($row_product_price['prices']);
  ...
  // get usetr order details
  function get_user_order_details(){
    global $con;
    $username=$_SESSION['username'];
    $get_details="Select * from user_table where username='$username'";
    $result_get_user=mysqli_query($con,$get_details);
    while($row_query=mysqli_fetch_array($result_get_user)){
