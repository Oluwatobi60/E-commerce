      ...
      $user_email=$row_fetch['user_email'];
       $user_address=$row_fetch['user_address'];
        ...
        if(isset($_POST['user_update'])){
            ...
            //update query 
            $update_data="update user_table set username='$username',user_email='$user_email',user_image='$user_image',user_address='$user_address',user_mobile='$user_contact' where user_id=$update_id";
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-outline mb-4">
            <input type="text" class="form-control w-50 m-auto" name="user_name" value="<?php  echo $username;  ?>">
        </div>
        ...
        <div class="form-outline mb-4 d-flex w-50 m-auto">
            ...
            <img src="./user_images/<?php echo $image; ?>" alt="" class="edit_image my-4">
        </div>
